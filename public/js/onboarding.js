...
function getInlineProfessionalForm(prefix, uid) {
    return `
        <div class="justify-between-flexbox mb-2" style="display: flex; justify-content: space-between; align-items: center;">
            <label class="form-label mb-0">Professional</label>
            <button type="button" class="btn btn-sm btn-link p-0 toggle_professional_btn" data-uid="${uid}">+ Add New Professional</button>
        </div>
        ...
        <div id="new_professional_box_${uid}" style="display: none; background: #fdfdfd; border: 1px solid #e2e8f0; padding: 15px; border-radius: 6px; margin-top: 5px;">
            <div class="row">
                <div class="col-md-3 mb-2">
                    <input type="text" class="form-control form-control-sm" name="${prefix}[prof_title]" placeholder="Title">
                </div>
                <div class="col-md-4 mb-2">
                    <input type="text" class="form-control form-control-sm prof_first_name_input" name="${prefix}[prof_first_name]" placeholder="First Name*">
                </div>
                <div class="col-md-5 mb-2">
                    <input type="text" class="form-control form-control-sm prof_last_name_input" name="${prefix}[prof_last_name]" placeholder="Last Name*">
                </div>
                <div class="col-md-6 mb-2">
                    <input type="text" class="form-control form-control-sm" name="${prefix}[prof_role]" placeholder="Role">
                </div>
                <div class="col-md-6 mb-2">
                    <input type="text" class="form-control form-control-sm" name="${prefix}[prof_agency]" placeholder="Agency">
                </div>
                <div class="col-md-6">
                    <input type="text" class="form-control form-control-sm" name="${prefix}[prof_phone]" placeholder="Phone">
                </div>
                <div class="col-md-6">
                    <input type="email" class="form-control form-control-sm" name="${prefix}[prof_email]" placeholder="Email">
                </div>
            </div>
...
$(document).on('click', '.toggle_professional_btn', function() {
    ...
    if (newBox.is(':hidden')) {
        ...
        newBox.show();
        isNewInput.val('1');
        $(this).text('Cancel').addClass('text-danger');
        ...
        newBox.hide();
        isNewInput.val('0');
        $(this).text('+ Add New Professional').removeClass('text-danger');
    ...
    const html = `
        <div class="onboarding_inner_form">
            ...
            <div class="row pt-2">
                ...
                <div class="col-md-6 mb-3">
                    <label class="form-label">State Support/Benefits</label>
    ...
    const html = `
        <div class="onboarding_inner_form">
            ...
            <div class="row pt-2">
                ...
                <div class="col-md-3 mb-3">
                    <label class="form-label">Type of Class</label>
                ...
                <div class="col-md-8 mb-3">
                    <label class="form-label">Reason for Transition</label>
...
function addDiagnosisRow() {
    const html = `
        <div class="onboarding_inner_form">
            ...
            <div class="row pt-2">
                <div class="col-md-6 mb-3">
                    <label class="form-label">Diagnosis Name <span class="text-danger">*</span></label>
            ...
            <div class="row pt-2">
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="self_administer_${medicationIdx}">Pupil can self-administer?</label>
                    </div>
                </div>
            </div>
        </div>
