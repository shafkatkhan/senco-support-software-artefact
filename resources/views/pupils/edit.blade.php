...
@section('content')
    <section id="content">
        <div class="section_title">
            <a href="{{ route('pupils.show', $pupil->id) }}" class="previous_icon"><i class="fas {{ is_rtl() ? 'fa-arrow-circle-right' : 'fa-arrow-circle-left' }}"></i></a> {{ __('Return back to pupil dashboard') }}
        </div>
        <div class="row settings_wrap onboarding_wrap">
            <div class="settings_section">
                <div class="title">
                    <i class="fas fa-user-edit me-2"></i>{{ __('Edit Pupil') }}
                </div>
                <div class="description">
                    {{ __('Update the pupil\'s profile fields. Related records such as medications, diagnoses, family members, and meetings are managed separately via the top navigation bar.') }}
                </div>
                <hr>
                <form action="{{ route('pupils.update', $pupil->id) }}" method="POST">
                    ...
                    <div class="description">
                        {{ __('Update the primary details for the pupil.') }}
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="gender" class="form-control" required>
                                ...
                                <option value="Male" {{ old('gender', $pupil->gender) == 'Male' ? 'selected' : '' }}>{{ __('Male') }}</option>
                                <option value="Female" {{ old('gender', $pupil->gender) == 'Female' ? 'selected' : '' }}>{{ __('Female') }}</option>
                                <option value="Other" {{ old('gender', $pupil->gender) == 'Other' ? 'selected' : '' }}>{{ __('Other') }}</option>
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">{{ __('Next of Kin') }}</label>
                            <select name="primary_family_member_id" class="form-control">
                                <option value="">{{ __('None / Not Set') }}</option>
                    ...
                    <div class="title" style="margin-bottom: 25px;">
                        <i class="fas fa-wheelchair me-2"></i>{{ __('SEN and Background') }}
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div id="special_needs_details_wrap" class="mt-2" style="display: none;">
                                <textarea name="special_needs_details" class="form-control" rows="2" placeholder="{{ __('If ticked, provide details here...') }}">{{ old('special_needs_details', $pupil->special_needs_details) }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="form-check form-switch">
                            ...
                            <div id="special_school_details_wrap" class="mt-2" style="display: none;">
                                <textarea name="special_school_details" class="form-control" rows="2" placeholder="{{ __('If ticked, provide details here...') }}">{{ old('special_school_details', $pupil->special_school_details) }}</textarea>
                            </div>
                        </div>
                        <div class="col-md-12 mb-3">
                            <div class="form-check form-switch">
                    ...
                    <hr>
                    <div class="title" style="margin-bottom: 25px;">
                        <i class="fas fa-shield-alt me-2"></i>{{ __('Safeguarding and Probation') }}
                    </div>
                    <div class="row">
                        <div class="col-md-12 mb-3 onboarding_inner_form">
                            ...
                            <div id="social_services_wrap" class="mt-2" style="display: none;">
                                <label class="form-label">{{ __('Social Worker') }}</label>
                        ...
                        <div class="col-md-12 mb-3 onboarding_inner_form">
                            ...
                            <div id="probation_officer_wrap" class="mt-2" style="display: none;">
                                <label class="form-label">{{ __('Probation Officer') }}</label>
