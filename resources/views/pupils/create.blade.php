        ...
        <div class="row settings_wrap onboarding_wrap">
            <div class="col-md-8 d-flex flex-column">                
                <div class="settings_section">
                    <div class="title">
                        <i class="fas fa-user-plus me-2"></i>{{ __('Onboard New Pupil') }}
                    </div>
                    <div class="description">
                        {{ __('Please fill in the comprehensive pupil information below.') }}
                    </div>
                    <hr>
                    <form action="{{ route('pupils.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="title">
                            <i class="fas fa-id-card me-2"></i>{{ __('Core Pupil Information') }}
                        </div>
                        <div class="description">
                            {{ __('Enter the primary details for the pupil.') }}
                        </div>
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label">{{ __('Pupil Number') }} <span class="text-danger">*</span></label>
                        ...
                        <hr>
                        <div class="title">
                            <i class="fas fa-folder-open me-2"></i>{{ __('Additional Information (Optional)') }}
                        </div>
                        <div class="description">
                            {{ __('Attach related family members, medical details, and other records to the pupil\'s profile.') }}
                        </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingFamilyMembers">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFamilyMembers">
                                        <i class="fas fa-users"></i> {{ __('Family Members') }}
                                    </button>
                                </h2>
                                <div id="collapseFamilyMembers" class="accordion-collapse collapse" data-bs-parent="#onboardingAccordion">
                                    <div class="accordion-body">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="addFamilyMemberRow()">+ {{ __('Add Family Member') }}</button>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingSchools">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSchools">
                                        <i class="fas fa-graduation-cap"></i> {{ __('School History') }}
                                    </button>
                                </h2>
                                <div id="collapseSchools" class="accordion-collapse collapse" data-bs-parent="#onboardingAccordion">
                                    <div class="accordion-body">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="addSchoolRow()">+ {{ __('Add School History') }}</button>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingBackground">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBackground">
                                        <i class="fas fa-wheelchair"></i> {{ __('SEN & Background') }}
                                    </button>
                                </h2>
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            <div class="col-12 mb-3">
                                                <label class="form-label">{{ __('Description of student by parents (or legal guardian)') }}</label>
                                            ...
                                            <div class="col-md-12 mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="has_special_needs">{{ __('Does the pupil have special needs?') }}</label>
                                                </div>
                                                <div id="special_needs_details_wrap" class="mt-2" style="display: none;">
                                                    <textarea name="special_needs_details" class="form-control" rows="2" placeholder="{{ __('If ticked, provide details here...') }}"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="attended_special_school">{{ __('Did the pupil attend a special needs school in the past?') }}</label>
                                                </div>
                                                <div id="special_school_details_wrap" class="mt-2" style="display: none;">
                                                    <textarea name="special_school_details" class="form-control" rows="2" placeholder="{{ __('If ticked, provide details here...') }}"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="smoking_history" name="smoking_history" value="1">
                                                    <label class="form-check-label" for="smoking_history">{{ __('Does the pupil have a smoking history?') }}</label>
                                                </div>
                                            </div>
                                            <div class="col-md-12 mb-3">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" id="drug_abuse_history" name="drug_abuse_history" value="1">
                                                    <label class="form-check-label" for="drug_abuse_history">{{ __('Does the pupil have a drug abuse history?') }}</label>
                                                </div>
                                            </div>
                                            <div class="col-12 mb-3">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingDiagnoses">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseDiagnoses">
                                        <i class="fas fa-stethoscope"></i> {{ __('Diagnoses') }}
                                    </button>
                                </h2>
                                <div id="collapseDiagnoses" class="accordion-collapse collapse" data-bs-parent="#onboardingAccordion">
                                    <div class="accordion-body">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="addDiagnosisRow()">+ {{ __('Add Diagnosis') }}</button>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingMedications">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMedications">
                                        <i class="fas fa-medkit"></i> {{ __('Medications') }}
                                    </button>
                                </h2>
                                <div id="collapseMedications" class="accordion-collapse collapse" data-bs-parent="#onboardingAccordion">
                                    <div class="accordion-body">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="addMedicationRow()">+ {{ __('Add Medication') }}</button>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingRecords">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseRecords">
                                        <i class="fas fa-file-alt"></i> {{ __('Records') }}
                                    </button>
                                </h2>
                                <div id="collapseRecords" class="accordion-collapse collapse" data-bs-parent="#onboardingAccordion">
                                    <div class="accordion-body">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary" onclick="addRecordRow()">+ {{ __('Add Record') }}</button>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingSafeguardingProbation">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSafeguardingProbation">
                                        <i class="fas fa-shield-alt"></i> {{ __('Safeguarding & Probation') }}
                                    </button>
                                </h2>
                                            ...
                                            <div class="col-md-12">
                                                <div class="onboarding_inner_form">
                                                    <div class="form-check form-switch">
                                                        ...
                                                        <label class="form-check-label" for="social_services_involvement">{{ __('Involvement of social services?') }}</label>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="onboarding_inner_form">
                                                    <div class="form-check form-switch">
                                                        ...
                                                        <label class="form-check-label" for="probation_officer_required">{{ __('Is visiting probation officer required?') }}</label>
                                                    </div>
            ...
            <div class="col-md-4 d-flex flex-column">
                <div class="settings_section" style="background-color: #ffffff91;">
                    ...
                    <div class="description">
                        {{ __('Use this comprehensive form to register a new pupil into the system. Some of the core information is required, while the additional sections allow you to optionally attach related records immediately.') }}
                    </div>
                    <ul class="small text-muted list-unstyled mb-0">
                        <li class="mb-2">
                            <i class="fas fa-check text-success me-2"></i>
                            <strong>{{ __('Core Details') }}:</strong> {{ __('Ensure name, DOB, and address are accurate. These form the primary profile identity.') }}
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check text-success me-2"></i>
                            <strong>{{ __('Family Members') }}:</strong> {{ __('You can add multiple parents, guardians, or siblings. Use the dropdown to define their relation. The first family member added will be set as the primary family member (next of kin).') }}
                        </li>
                        <li class="mb-2">
                            <i class="fas fa-check text-success me-2"></i>
                            <strong>{{ __('Medical & Records') }}:</strong> {{ __('Relevant history, diagnoses, and tracked support records can be logged inline and will instantly populate the pupil\'s respective data tables.') }}
                        </li>
                        <li>
                            <i class="fas fa-check text-success me-2"></i>
                            <strong>{{ __('Adding Rows') }}:</strong> {{ __('You must explicitly click the "+ Add" buttons to reveal the form fields for any optional subsections.') }}
                        </li>
                    </ul>
                </div>
            </div>
