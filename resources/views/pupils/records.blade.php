                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                <div class="justify-between-flexbox">
                                    ...
                                    <button type="button" class="btn btn-sm btn-link p-0" id="toggle_professional_btn">+ Add New Professional</button>
                                </div>
                                ...
                                <div id="new_professional_box">
                                    <div class="row">
                                        <div class="col-md-3 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="prof_title" placeholder="Title">
                                        </div>
                                        <div class="col-md-4 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="prof_first_name" placeholder="First Name*">
                                        </div>
                                        <div class="col-md-5 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="prof_last_name" placeholder="Last Name*">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="prof_role" placeholder="Role">
                                        </div>
                                        <div class="col-md-6 mb-2">
                                            <input type="text" class="form-control form-control-sm" name="prof_agency" placeholder="Agency">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-sm" name="prof_phone" placeholder="Phone">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="email" class="form-control form-control-sm" name="prof_email" placeholder="Email">
                                        </div>
                                    </div>
