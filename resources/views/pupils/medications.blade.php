            ...
            <div style="display: flex; gap: 10px; justify-content: flex-end;">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <a class="dropdown-item" href="{{ route('pupils.medications.export', ['pupil' => $pupil->id, 'format' => 'excel']) }}">
                                <i class="fas fa-file-excel text-success"></i> {{ __('Export to Excel') }}
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('pupils.medications.export', ['pupil' => $pupil->id, 'format' => 'csv']) }}">
